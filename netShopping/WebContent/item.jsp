			...
			<div id="center_column">				
				...
				<div id=item_other>
					<form action="cart_view.jsp" method="post">
						...
						原&nbsp;&nbsp;&nbsp;&nbsp;价：&nbsp;<span  style="text-decoration: line-through;"><jsp:getProperty property="onePrice" name="product"/>元</span><br>
						促&nbsp;&nbsp;&nbsp;&nbsp;销：&nbsp;<span  style="font-size:28px;font-weight:bold;color:#B22222;"><jsp:getProperty property="price" name="product"/></span>元<br>
						售&nbsp;&nbsp;&nbsp;&nbsp;出：&nbsp;<span  style="font-weight:bold;color:#CC6600;"><jsp:getProperty property="onePrice" name="product"/></span>件<br>
						...
						<input type="hidden" name="name" value="<jsp:getProperty property="name" name="product"/>">
						<input type="hidden" name="price" value="<jsp:getProperty property="price" name="product"/>">
